...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(
            "**Download the [training dataset found in our GitHub repo](https://github.com/iragca/ml-final-project/raw/refs/heads/master/data/processed/CivilServiceCommission/civilservicecommission.parquet).**"
        )
